...
(function() {
	...
	(function() {
		...
		CKEDITOR.tools = {
			...
			objectCompare: function(a, b, c) { var h; if(!a && !b) return !0; if(!a || !b) return !1; for(h in a)
					if(a[h] != b[h]) return !1; if(!c)
					for(h in b)
						if(a[h] != b[h]) return !1; return !0 },
			...
			getDocumentPosition: function(a) {
				...
				if(document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
					...
					for(m = this, x = null; m && "body" != m.getName() &&
						...
						x = m;
						m = (e = m.$.offsetParent) ? new CKEDITOR.dom.element(e) : null } a && (e = this.getWindow(), m = a.getWindow(), !e.equals(m) && e.$.frameElement && (a = (new CKEDITOR.dom.element(e.$.frameElement)).getDocumentPosition(a), b += a.x, c += a.y));
			...
			if(l && n.type == CKEDITOR.NODE_TEXT && q.equals(n)) q = a.document.createText(q.substring(t, A)), c.append(q);
				...
				for(var P = q.getParents(), v = n.getParents(), G = g(), E = P.length - 1, I = v.length - 1, K = c, L, Z, X, fa = -1, S = G; S <= E; S++) {
					Z =
						P[S];
					X = Z.getNext();
					for(S != E || Z.equals(v[S]) && E < I ? b && (L = K.append(Z.clone(0, e))) : C ? m(Z, K, !1, M) : p && K.append(a.document.createText(Z.substring(t))); X;) { if(X.equals(v[S])) { fa = S; break } X = m(X, K) } K = L
				}
				K = c;
				for(S = G; S <= I; S++)
			...
			trim: function(a, b) {
				...
				if((!a ||
						...
						if(d >= c.getLength()) d = c.getIndex() + 1, c = c.getParent();
								...
								d = c.getIndex() + 1,
								c = c.getParent();
							this.startContainer.equals(this.endContainer) ? this.setEnd(m, this.endOffset - this.startOffset) : c.equals(this.endContainer) && (this.endOffset += 1) } else d = c.getIndex(), c = c.getParent();
				...
				switch(a) {
					...
					case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
						...
						if(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) { l = this.clone();
							...
							l.evaluator = function(a) { return !E(a) && !I(a) }; if((l = l.previous()) && l.type == CKEDITOR.NODE_ELEMENT && l.is("br")) break } l = this.clone();
						l.collapse();
				...
				for(this._.nextNode = null; x;) {
					...
					if(F) x.type == CKEDITOR.NODE_TEXT && e.test(x.getText()) && (F = 0);
						...
						if(CKEDITOR.dtd.$block[q] && "false" == x.getAttribute("contenteditable")) { d = x;
							b(this, a, d); break } else if(x.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { if("br" == q) F = 1;
								...
								u = x.equals(m); break } k && (k.setEndAt(x, CKEDITOR.POSITION_BEFORE_START), "br" != q && (this._.nextNode = x));
							J = 1 } else { if(x.getFirst()) { k || (k = this.range.clone(), k.setStartAt(x, CKEDITOR.POSITION_BEFORE_START));
								x = x.getFirst(); continue } F = 1 }
					}
					...
					if(k && !J)
						for(; !x.getNext(h) && !u;) { q = x.getParent(); if(q.isBlockBoundary(this.forceBrBreak && !w && { br: 1 })) { J = 1;
								F = 0;
								u || q.equals(m);
								k.setEndAt(q, CKEDITOR.POSITION_BEFORE_END); break } x = q;
							F = 1;
							u = x.equals(m);
							l = 1 } F && k.setEndAt(x, CKEDITOR.POSITION_AFTER_END);
	...
	(function() {
		function a(a, b, c, d, l) {
			...
			for(d = a.length; c < d; ++c) {
				...
				for(t in P) { f = P[t];
					...
					g = E;
					g.length && (n[f] = g, m = !1) } n.nothingRequired = m;
		...
		function e(a,
			b) { if(!a) return !1; var c = !1,
				d = !0 === a,
				l; for(l in b)
				if(d || a(l)) delete b[l], c = !0; return c }
		...
		CKEDITOR.filter.prototype = {
			allow: function(b, c, d) {
				...
				} else if(CKEDITOR.tools.isArray(b)) { for(l = 0; l < b.length; ++l) e = this.allow(b[l], c, d); return e } a(this, b, c, this.allowedContent, this._.allowedRules);
				return !0
			},
				...
				CKEDITOR.scriptLoader.load(e, function() {
					for(var c = ["beforeInit", "init", "afterInit"], e = 0; e < c.length; e++)
						for(var q =
							...
							0 === e && l[q] && n.lang && n.langEntries && (a.lang[n.name] = n.langEntries[l[q]]); if(n[c[e]]) n[c[e]](a) } a.fireOnce("pluginsLoaded");
		...
		CKEDITOR.tools.extend(CKEDITOR.editor.prototype, {
			...
			getSelectedHtml: function(a) {
				...
				for(var d = new CKEDITOR.dom.documentFragment, e, l, q, n = 0; n < c.length; n++) { var f = c[n],
						g = f.startContainer;
					g.getName && "tr" == g.getName() ? (e || (e = g.getAscendant("table").clone(), e.append(g.getAscendant("tbody").clone()), d.append(e), e = e.findOne("tbody")), l && l.equals(g) || (l = g, q = g.clone(), e.append(q)), q.append(f.cloneContents())) : d.append(f.cloneContents()) } b = e ? d : b.getHtmlFromRange(c[0]);
					...
					if(k) k.push(c[0]);
							...
							c = !!c[5]; if(r)
								for(; p = a.exec(r);) { var f = p[1].toLowerCase();
									p = p[2] || p[3] || p[4] || "";
									h[f] = !p && d[f] ? f : CKEDITOR.tools.htmlDecodeAttr(p) } this.onTagOpen(e, h, c);!k && CKEDITOR.dtd.$cdata[e] && (k = []) } } else if(e = c[2]) this.onComment(e)
				}
	...
	(function() {
		...
		function d(b, c, d, g) { var k, h; for(k in c)(h = b[k]) || (h = b[k] = new a), h.add(c[k], d, g) } CKEDITOR.htmlParser.filter = CKEDITOR.tools.createClass({
		...
		CKEDITOR.htmlParser.element.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
			...
			filter: function(a, b) {
				...
				for(;;) { k = d.name; if(!(h = a.onElementName(b, k))) return this.remove(), !1;
					d.name = h; if(!(d = a.onElement(b, d))) return this.remove(), !1; if(d !== this) return this.replaceWith(d), !1; if(d.name == k) break; if(d.type != CKEDITOR.NODE_ELEMENT) return this.replaceWith(d), !1; if(!d.name) return this.replaceWithChildren(), !1 } k = d.attributes;
				var p, r;
				for(p in k) {
					for(h = k[p];;)
					...
					else { delete k[p]; break } r && (!1 === (h = a.onAttribute(b, d, r, h)) ? delete k[r] :
						k[r] = h)
				}
			...
			proto: {
				...
				fixInitialSelection: function() {
					function a() { var b = c.getDocument().$,
						...
						a: if(d.anchorNode && d.anchorNode == c.$) l = !0;
							else { if(CKEDITOR.env.webkit && (l = c.getDocument().getActive()) && l.equals(c) && !d.anchorNode) { l = !0; break a } l = void 0 }
				...
				extractHtmlFromRange: function(a, b) {
					...
					if(b) { c = a.startPath(); if(d = a.checkStartOfBlock() && a.checkEndOfBlock() && c.block && !a.root.equals(c.block)) { a: { var d = c.block.getElementsByTag("span"),
									...
									for(; g = d.getItem(f++);)
										if(!B(g)) { d = !0; break a }
								d = !1 } d = !d } d && (a.moveToPosition(c.block, CKEDITOR.POSITION_BEFORE_START), c.block.remove()) } else c.autoParagraph(this.editor, a), u(a.startContainer) && a.startContainer.appendBogus();
				...
				if(!E.checkReadOnly()) {
					...
					if(H = G) {
						...
						if(/^\s+|\s+$/.test(G) && "span" in CKEDITOR.dtd[u]) { var z = '\x3cspan data-cke-marker\x3d"1"\x3e\x26nbsp;\x3c/span\x3e';
							G = z + G + z } G = m.editor.dataProcessor.toHtml(G, { context: null, fixForBody: !1, protectedWhitespaces: !!z, dontFilter: m.dontFilter, filter: m.editor.activeFilter, enterMode: m.editor.activeEnterMode });
						...
						for(D(v, w); E < v.length; E++) {
							...
							if(y) G = 0 < E;
								...
								if((y = w.startPath().block) && !y.equals(N)) { if(O = y.getBogus()) O.remove(), z.push(y);
									N = y } L.firstNotAllowed && (I = 1);
								if(I && L.isElement) {
									y = w.startContainer;
									for(F = null; y && !p[y.getName()][L.name];) { if(y.equals(u)) { y = null; break } F = y;
										y = y.getParent() }
			...
			tree: {
				rebuild: function(a, b) {
					...
					if(e.blockLimit.is({
						...
						g = function(a) { return !a.equals(h) } } g || (g = function(a) { return !a.equals(e.block) && !a.equals(e.blockLimit) });
			...
			return {
				list: {
					...
					merge: function(a, c) { if(a.mergeListBookmark) { var d = a.mergeListBookmark.startNode,
								...
								g.equals(n) || (n.moveChildren(g), n.remove()) } a.mergeListItems && (f = f.contains(CKEDITOR.dtd.$listItem), l = l.contains(CKEDITOR.dtd.$listItem), f.equals(l) || b(l, d, e));
							d.remove();
							e.remove() } }
				},
				block: {
	...
	(function() {
					...
					if("BackCompat" != f.$.compatMode) {
						if(CKEDITOR.env.ie7Compat || CKEDITOR.env.ie6Compat) {
							...
							q.on("mousedown", function(a) {
								function b(a) { a = a.data.$; if(E) { var c = h.$.createTextRange(); try { c.moveToPoint(a.clientX, a.clientY) } catch(d) {} E.setEndPoint(0 > I.compareEndPoints("StartToStart", c) ? "EndToEnd" : "StartToStart", c);
										E.select() } }
								...
								a = a.data;
								if(a.getTarget().is("html") && a.$.y < q.$.clientHeight && a.$.x < q.$.clientWidth) { E = h.$.createTextRange(); try { E.moveToPoint(a.$.clientX, a.$.clientY) } catch(d) {} I = E.duplicate();
									q.on("mousemove", b);
									l.on("mouseup", c);
									q.on("mouseup", c) }
							})
		...
		CKEDITOR.dom.selection.prototype = {
			...
			removeAllRanges: function() { if(this.getType() != CKEDITOR.SELECTION_NONE) { var a = this.getNative(); try { a && a[B ? "empty" : "removeAllRanges"]() } catch(b) {} this.reset() } }
		}
	})();
	"use strict";
	...
	(function() {
					...
					if(u.equals(r)) u = null, k = !0;
						...
						if(w && m && CKEDITOR.dtd.$block[z])
							for(var B = u, A = e(B), C = void 0, D = A.length, F = 0, B = D && new CKEDITOR.dom.range(B.getDocument()); F < D; ++F) { var C = A[F],
									M = CKEDITOR.filter.instances[C.data("cke-filter")]; if(M ? M.check(this) : 1) B.selectNodeContents(C), b.call(this, B) } A = z ? !n[z] || x ? 0 : w && !m ? 0 : d(u, r, h, Q) : 1;
						if(A)
		...
		function c(a) {
			function b() { for(var a = new CKEDITOR.dom.elementPath(d.getParent()), c = new CKEDITOR.dom.elementPath(n.getParent()), e = null, f = null, g = 0; g < a.elements.length; g++) { var h = a.elements[g]; if(h == a.block || h == a.blockLimit) break;
					...
					p.checkElementRemovable(h, !0) && (f = h) } f && n.breakParent(f);
			...
			if(a.collapsed) {
				...
				if(f) {
					...
					p = this;
				b(); for(e = d; !e.equals(n);) f = e.getNextSourceNode(), e.type == CKEDITOR.NODE_ELEMENT && this.checkElementRemovable(e) && (e.getName() == this.element ? z.call(this, e) : m(e, l(this)[e.getName()]), f.type == CKEDITOR.NODE_ELEMENT && f.contains(d) && (b(), f = d.getNext())), e = f } a.moveToBookmark(c);
		...
		CKEDITOR.style.getStyleText = function(a) {
			...
			for(var e in b) { var f = b[e],
					g = (e + ":" + f).replace(D, ";"); "inherit" == f ? d += g : c += g } c.length && (c = CKEDITOR.tools.normalizeCssText(c, !0));
			return a._ST = c + d
		};
	...
	*/
	...
	(function() {
		...
		function z(b) {
			...
			function c(a) { return { type: a, canUndo: "cut" == a, startDisabled: !0, fakeKeystroke: "cut" == a ? CKEDITOR.CTRL + 88 : CKEDITOR.CTRL + 67, exec: function() { "cut" == this.type && h(); var a; var c = this.type; if(CKEDITOR.env.ie) a = d(c);
						else try { a = b.document.$.execCommand(c, !1, null) } catch(g) { a = !1 } a || b.showNotification(b.lang.clipboard[this.type + "Error"]); return a } } }
			...
			(function() {
				function a(c, d, g, e, h) { var k = b.lang.clipboard[d];
					...
					b.addMenuItems && b.addMenuItem(d, { label: k, command: d, group: "clipboard", order: h }) } a("Cut", "cut", c("cut"), 10, 1);
		...
		CKEDITOR.plugins.clipboard.dataTransfer = function(b, a) {
			...
			if("Text" != p) try { this.$.setData(p, this.id) } catch(c) {} a && (this.sourceEditor =
	...
	CKEDITOR.plugins.add("colorbutton", {
		...
		init: function(e) {
			function t(a, c, f, g, l) {
				...
				e.ui.add(a, CKEDITOR.UI_PANELBUTTON, {
					...
					onBlock: function(a,
						...
						CKEDITOR.ui.fire("ready", this); var d = b.keys,
							f = "rtl" == e.lang.dir;
						d[f ? 37 : 39] = "next";
						d[40] = "next";
						d[9] = "next";
					...
					b = CKEDITOR.tools.addFunction(function(b, c) {
						...
						if("?" == b) e.openDialog("colordialog", function() { this.on("ok", d);
							...
							if(b) {
								...
								g.childRule = "back" ==
									c ? function(a) { return u(a) } : function(a) { return !(a.is("a") || a.getElementsByTag("a").count()) || u(a) };
			...
			function u(a) { return "false" == a.getAttribute("contentEditable") || a.getAttribute("data-nostyle") }
			var k = e.config,
	...
	(function() {
		function r(a) { var b = (a = a.data) && a.$; return a && b ? CKEDITOR.env.ie && 9 > CKEDITOR.env.version ? 1 === b.button : 0 === b.button : !1 }
		...
		function u(a, b) { var e = { ul: "ol", ol: "ul" }; return -1 !== l(b, function(b) { return b.element === a || b.element === e[a] }) }
		...
		q.prototype._isContextAllowed = function(a) { var b = this.editor.config.copyFormatting_allowedContexts; return !0 === b || -1 !== l(b, a) };
		...
		CKEDITOR.plugins.copyformatting = {
			...
			_extractStylesFromElement: function(a, b) {
				...
				do
					if(b.type === CKEDITOR.NODE_ELEMENT && !b.hasAttribute("data-cke-bookmark") &&
						(e.element = b, a.copyFormatting.fire("extractFormatting", e, a) && e.styleDef && d.push(new CKEDITOR.style(e.styleDef)), b.getName && -1 !== l(CKEDITOR.plugins.copyformatting.breakOnElements, b.getName()))) break; while ((b = b.getParent()) && b.type === CKEDITOR.NODE_ELEMENT);
				return d
			},
			...
			_getSelectedWordOffset: function(a) {
				...
				function d(a, c) {
					var f = a,
						...
						k = !1,
						p, n;
					do { for(p = b(f, c); !p && f.getParent();) { f = f.getParent(); if(-1 !== l(h, f.getName())) { k = m = !0; break } p = b(f, c) } if(p && p.getName && -1 !== l(h, p.getName())) { m = !0; break } f = p } while (f && f.getStyle && ("none" == f.getStyle("display") || !f.getText()));
			...
			_applyStylesToTextContext: function(a, b, e) {
				...
				for(f = 0; f < e.length; f++)
					if(b = e[f], -1 === l(d.excludedElementsFromInlineTransform, b.element)) { if(-1 !== l(d.elementsForInlineTransform, b.element))
		...
		CKEDITOR.plugins.add("flash", {
			...
			afterInit: function(a) { var b = a.dataProcessor;
				(b = b && b.dataFilter) && b.addRules({ elements: { "cke:object": function(b) { var c = b.attributes; if(!(c.classid && String(c.classid).toLowerCase() || d(b))) { for(c = 0; c < b.children.length; c++)
								...
								return null } return e(a, b) }, "cke:embed": function(b) { return d(b) ? e(a, b) : null } } }, 5) }
		})
	})();
	...
	(function() {
		function n(a, c, h, e, q, n, u, w) {
			var x = a.config,
				...
				g = q.split(";");
			q = [];
			for(var m = {}, d = 0; d < g.length; d++) { var l = g[d]; if(l) { var l = l.split("/"),
						v = {},
						p = g[d] = l[0];
					v[h] = q[d] = l[1] || p;
					m[p] = new CKEDITOR.style(u, v);
					m[p]._.definition.name = p } else g.splice(d--, 1) } a.ui.addRichCombo(c, {
				label: e.label,
				title: e.panelTitle,
				toolbar: "styles," + w,
				allowedContent: r,
				...
				init: function() { this.startGroup(e.panelTitle); for(var b = 0; b < g.length; b++) { var a = g[b];
				...
				onClick: function(b) {
					...
					if(c && b != c) {
						...
						if(f.collapsed) {
							var g = a.elementPath(),
								k = g.contains(function(a) { return e.checkElementRemovable(a) });
							if(k) {
				...
				onRender: function() {
					a.on("selectionChange", function(b) {
						...
						for(var d = 0, e; d < b.length; d++) {
							e = b[d];
							for(var f in m)
								if(m[f].checkElementMatch(e, !0, a)) { f != c && this.setValue(f); return }
						}
						this.setValue("", n)
					}, this)
				},
		...
		function t(a, c, h) { var e = c.pop(); if(e) { if(h) return t(a, c, e.equals(h) ? null : h);
				h = e.clone();
				a.insertNode(h);
